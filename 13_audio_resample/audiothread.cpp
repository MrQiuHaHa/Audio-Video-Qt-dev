...
// 这种方式传指针地址的释放方式可以防止被这里已经释放的对象且还是被外面拿来使用，
// 可以避免外面野指针
//void freep(void **ptr) {
//    free(*ptr);
//    *ptr = nullptr;
